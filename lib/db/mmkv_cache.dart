...
import 'package:jin_video/db/mmkv_cache.dart';
...
class PlayListMMKVCache extends MMKVCache  {
  PlayListMMKVCache._() : super(MMKV(MMKVMmapID.playList.mmapID));
...
class PlayHistoryMMKVCache extends MMKVCache  {
  PlayHistoryMMKVCache._() : super(MMKV(MMKVMmapID.playHistory.mmapID));
...
class DanmakuMMKVCache extends MMKVCache  {
  DanmakuMMKVCache._() : super(MMKV(MMKVMmapID.danmaku.mmapID));
...
class SubtitleMMKVCache extends MMKVCache  {
  SubtitleMMKVCache._() : super(MMKV(MMKVMmapID.subtitle.mmapID));
